  ...
  render() {
    ...
    return (
      <div>
        ...
        <Button
          color={window.innerWidth > 960 ? "transparent" : "white"}
          justIcon={window.innerWidth > 960}
          simple={!(window.innerWidth > 960)}
        ...
        <div className={classes.manager}>
          ...
          <Poppers
            ...
            disablePortal
            className={
              classNames({ [classes.popperClose]: !openNotifcation }) + " " + classes.popperNav
            }>
                  ...
                  <ClickAwayListener onClickAway={this.handleCloseNotification}>
                    <MenuList role="menu">
                      <MenuItem
                        ...
                        Vous avez un nouveau message de Martin
                      </MenuItem>
                      <MenuItem
                        onClick={this.handleCloseNotification}
                        className={classes.dropdownItem}>
                        M.Poirier est en etat critique (13h10)
                      </MenuItem>
                      <MenuItem
                        onClick={this.handleCloseNotification}
                        className={classes.dropdownItem}>
                        M.Poirier est en etat critique (13:30)
                      </MenuItem>
                      <MenuItem
                        onClick={this.handleCloseNotification}
                        className={classes.dropdownItem}>
                        M.Poirier est transporté au CHUM
                      </MenuItem>
                      <MenuItem
                        onClick={this.handleCloseNotification}
                        className={classes.dropdownItem}>
                        Vous avez un nouveau message de Vanessa
                      </MenuItem>
                    </MenuList>
                  </ClickAwayListener>
                </Paper>
        ...
        <div className={classes.manager}>
          <Button
            ...
            color={window.innerWidth > 1024 ? "transparent" : "white"}
            justIcon={window.innerWidth > 1024}
              ...
              <Grow
                ...
                <Paper>
                  <ClickAwayListener onClickAway={this.handleCloseProfile}>
                    <MenuList role="menu">
                      <MenuItem onClick={this.handleCloseProfile} className={classes.dropdownItem}>
                        Profile
                      </MenuItem>
                      <MenuItem onClick={this.handleCloseProfile} className={classes.dropdownItem}>
                        Settings
